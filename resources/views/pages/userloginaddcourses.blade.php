...
@section('title', "Courses Display")

@section('keywords', "register, course, show, well done, wd school")
@section('description', "User display all courses to select courses to register")

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex justify-content-center">
      <h3 class="display-3 fw-bold map-header mb-3 custom-border me-2">
        Available Courses
      </h3>
        ...
        <div class="row justify-content-center">
            ...
            @else
                @foreach($courses as $course)
                    ...
                    <div class="custom-border col-sm-12 col-md-12 col-lg-4 col-xl-3 me-3 mb-2">
